...
class CalcFrame(MyFrame1):
    ...
    def perform_search(self, event):
        ...
        self.filtered_data = listing_data[listing_data['city'].str.strip().str.title() == suburb]
        ...
        columns_to_display = [
            'name', 'property_type', 'room_type', 'bedrooms', 'bathrooms', 'accommodates', 'review_scores_value', 'price',
        ]
    ...
    def applyFilters(self, event):
        ...
        try:
            ...
            # Handle invalid input (e.g., non-numeric or empty strings)
        ...
        # Apply additional filters to the copied DataFrame
        if min_rating:
